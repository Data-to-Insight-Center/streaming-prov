...
public class ProvState {
    ...
    public boolean startedCurrentInterval = false;
    public long numBytes;
    public long numBytesCurrentInterval;
    public long startTime;
    public long startTimeCurrentInterval;
...
//    public Set<String> nodes = new HashSet<>();
    ...
    public void clearState() {
        count = 0;
        numBytesCurrentInterval = 0;
        startedCurrentInterval = false;
        startTimeCurrentInterval = 0;
