...
public class PengSerialConsumer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<ObjectNode> stream = env.addSource(new FlinkKafkaConsumer010<ObjectNode>(
                fileProps.getProperty("kafka.topic"), new JSONKeyValueDeserializationSchema(false) {
        }, properties));
